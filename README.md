...
[![Build Status](https://img.shields.io/github/actions/workflow/status/kwhitley/itty-packager/verify.yml?branch=main&style=flat-square)](https://github.com/kwhitley/itty-packager/actions/workflows/verify.yml)
