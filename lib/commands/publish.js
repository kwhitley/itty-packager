...
async function getCommitMessage(newVersion, silent = false) {
  ...
  return new Promise((resolve) => {
    ...
    // Show placeholder that gets cleared on typing
    process.stdout.write('💬 Commit message: \x1b[90mpress enter to skip\x1b[0m')
    ...
    rl.on('line', (input) => {
      if (!placeholderCleared) {
        // Clear the placeholder line and move cursor to start
        process.stdout.write('\r💬 Commit message: ')
