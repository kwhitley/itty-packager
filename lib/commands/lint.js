...
`)
  ...
  // Find itty-packager's ESLint binary and config
  ...
  // Run ESLint using itty-packager's binary but from the project directory
  return new Promise((resolve, reject) => {
    const eslint = spawn(eslintBinary, eslintArgs, {
      stdio: 'inherit',
      cwd: process.cwd(),
      shell: true,
      env: { 
